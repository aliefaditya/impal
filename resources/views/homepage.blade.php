...
<html lang="en">
  <head>
    <title>ASSES - Antrean Kesehatan</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="solutions.html" class="nav-link">Jadwal Poli</a></li>
            ...
            <li class="nav-item"><a href="blog.html" class="nav-link">Masuk</a></li>
        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-10 ftco-animate text-center">
              ...
              <p><a href="https://vimeo.com/45830194" class="btn btn-primary btn-outline-white px-4 py-3 popup-vimeo"><span class="ion-ios-play mr-2"></span> Daftar Sekarang</a></p>
            </div>
          </div>
        </div>
      </div>
